---
title: "Google Docs"
description: "Google Docs is an online word processor that lets you create and format text documents."
---
...
* **Permissions:** Select the scopes you've requested for your application. They should begin with docs.
