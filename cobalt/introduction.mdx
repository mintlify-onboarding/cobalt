...
If you haven't created an account, head over to the [Signup Page](https://gocobalt.io/sign-up) and create a new account. Use company name and unique email id to create an account. Afterward you will be redirected to the dashboard of cobalt.

Go to the [Application key](https://gocobalt.io) page in the Cobalt dashboard. Copy your production and staging application key.

### How Cobalt works?

This guide will get you up and running with Cobalt. It will show you how to:

* ****[**Setup App events**](/cobalt/getting-started/setup-app-events)****

* ****[**Enable & configure Apps**](/cobalt/getting-started/enable-and-configure-app)****

* ****[**Create a linked account**](/cobalt/getting-started/create-a-linked-account)****

* ****[**Add to integrations your frontend application**](/cobalt/getting-started/add-to-your-frontend)****
