...
To create an event, go to the [**Your App** ![](/images/cobalt/getting-started/image.png)](https://app.gocobalt.io/your-app)page in Cobalt dashboard. Under the event tab click on add new event. Next, enter the name and event schema of your Event. The **event schema** that you enter here should be an example payload sent from your application to Cobalt.

The **event schema** must be a valid JSON object, and can contain any arbitrary JSON.

![](/images/cobalt/getting-started/Screenshot%202023-01-16%20at%203.38.42%20PM.png)

App Events can be sent from your application using the REST API to the below endpoint unique to your application.

![](/images/cobalt/getting-started/Untitled%20design.png)
