...
In your frontend, use our frontend SDK [@cobaltio/react-cobalt-js](https://www.npmjs.com/package/@cobaltio/react-cobalt-js) to open your user’s integration authorization session and template installer.

You can also use your own components for rendering by using our custom JavaScript SDK [@cobaltio/cobalt-js](https://www.npmjs.com/package/@cobaltio/cobalt-js).

[![](/images/cobalt/getting-started)npm: @cobaltio/react-cobalt-jsnpm](https://www.npmjs.com/package/@cobaltio/react-cobalt-js)

React SDK

[![](/images/cobalt/getting-started)npm: @cobaltio/cobalt-jsnpm](https://www.npmjs.com/package/@cobaltio/cobalt-js)
