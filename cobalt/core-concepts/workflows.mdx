...
Once your users have created a custom app to interact with your application, you
can build workflows that connect data between your application and your users'
apps. Cobalt's visual workflow builder allows you to create custom integrations
that your users can activate in their integrations.
